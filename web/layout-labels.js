(() => {
 const labels={zh:{character:'角色',close:'关闭 / ESC',choose:'选择角色',edit:'人设与记忆',gallery:'立绘素材',auto:'自动翻页'},en:{character:'Character',close:'Close / ESC',choose:'Choose character',edit:'Persona & memory',gallery:'Artwork',auto:'Auto advance'},ja:{character:'キャラ',close:'閉じる / ESC',choose:'キャラ選択',edit:'人格と記憶',gallery:'立ち絵素材',auto:'自動送り'}};
