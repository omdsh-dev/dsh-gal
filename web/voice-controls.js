...
(() => {
  ...
  function render(){
    ...
    for(const [id,key] of Object.entries({'btn-replay':'replay','btn-stop-voice':'stop','btn-history':'log','btn-memory':'memory','btn-artifacts':'artifacts','btn-char':'char','btn-edit':'edit','btn-gallery':'gallery','btn-hide':'hide','btn-send':'send'}))$(id).textContent=t(key);
